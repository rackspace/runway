...
class RunwayModuleType(object):
    ...
    EXTENSION_MAP = {
        'sls': 'r4y.module.serverless.Serverless',
        'tf': 'r4y.module.terraform.Terraform',
        'cdk': 'r4y.module.cdk.CloudDevelopmentKit',
        'k8s': 'r4y.module.k8s.K8s',
        'cfn': 'r4y.module.cloudformation.CloudFormation',
        'web': 'r4y.module.staticsite.StaticSite'
    }
