...
class Source(object):
    ...
    created by default in the users home directory: ``~/.r4y_cache``.
    ...
    def __init__(self, cache_dir='', **_):
        ...
        if not self.cache_dir:
            self.cache_dir = os.path.expanduser("~/.r4y_cache")  # type: str
    ...
    def __create_cache_directory(self):
        # type: () -> None
        """If no cache directory exists for the remote r4y modules, create one."""
