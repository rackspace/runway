...
def s3_fallback(fqn, template, parameters, tags, method,
    ...
    LOGGER.warning("DEPRECATION WARNING: Falling back to legacy "
                   ...
                   "https://docs.onica.com/projects/r4y/en/release/"
...
def output_full_changeset(full_changeset=None, params_diff=None,
    ...
    Args:
        ...
        params_diff (Optional[List[:class:`r4y.cfngin.actions.diff.DictValue`):
            A list of DictValue detailing the differences between two
            parameters returned by
            :func:`r4y.cfngin.actions.diff.diff_dictionaries`.
...
def ask_for_approval(full_changeset=None, params_diff=None,
    ...
    Args:
        full_changeset (Optional[List[Dict[str, Any]]]): A list of the full
            changeset that will be output if the user specifies verbose.
        params_diff (Optional[List[:class:`r4y.cfngin.actions.diff`]]):
            A list of DictValue detailing the differences between two
            parameters returned by
            :func:`r4y.cfngin.actions.diff.diff_dictionaries`
...
def format_params_diff(params_diff):
    """Wrap :func:`r4y.cfngin.actions.diff.format_params_diff` for testing."""
...
def generate_cloudformation_args(stack_name, parameters, tags, template,
    ...
    Args:
        ...
        template (:class:`r4y.cfngin.provider.base.Template`): The template
            object.
        ...
        stack_policy (:class:`r4y.cfngin.providers.base.Template`):
...
class Provider(BaseProvider):
    ...
    def create_stack(self, fqn,  # pylint: disable=arguments-differ
        ...
        Args:
            ...
            template (:class:`r4y.cfngin.providers.base.Template`):
    ...
    def noninteractive_destroy_stack(self, fqn, **kwargs):  # pylint: disable=unused-argument
    ...
    def noninteractive_changeset_update(self, fqn, template,
                                        old_parameters,  # pylint: disable=unused-argument
                                        parameters, stack_policy, tags):
    ...
    def default_update_stack(self, fqn, template,
                             old_parameters,  # pylint: disable=unused-argument
    ...
    def get_stack_changes(self, stack, template, parameters, tags):
        ...
        Args:
            stack (:class:`r4y.cfngin.stack.Stack`): The stack to get
                changes.
            template (:class:`r4y.cfngin.providers.base.Template`):
