...
from r4y.util import MutableMap  # abs to support import through shim
...
class Context(object):
    ...
    def __init__(self,
        ...
        Args:
            ...
            stack_names (list): A list of stack_names to operate on. If not
                ...
                operated on.
            config (:class:`r4y.cfngin.config.Config`): The CFNgin
    ...
    def persistent_graph(self, graph_dict):
        """Load a persistent graph dict as a :class:`r4y.cfngin.plan.Graph`."""
    ...
    def get_targets(self):
        ...
        Returns:
            list: a list of :class:`r4y.cfngin.target.Target` objects
    ...
    def get_stacks(self):
        ...
        Handles configuring the :class:`r4y.cfngin.stack.Stack` objects
        that will be used in the current action.

        Returns:
            list: a list of :class:`r4y.cfngin.stack.Stack` objects
    ...
    def lock_persistent_graph(self, lock_code):
        ...
        Raises:
            :class:`r4y.cfngin.exceptions.PersistentGraphLocked`
            :class:`r4y.cfngin.exceptions.PersistentGraphCannotLock`
    ...
    def put_persistent_graph(self, lock_code):
        ...
        Raises:
            :class:`r4y.cfngin.exceptions.PersistentGraphUnlocked`
            :class:`r4y.cfngin.exceptions.PersistentGraphLockCodeMissmatch`
    ...
    def unlock_persistent_graph(self, lock_code):
        ...
        Raises:
            :class:`r4y.cfngin.exceptions.PersistentGraphCannotUnlock`
