...
from r4y.util import load_object_from_string
from r4y.variables import Variable, resolve_variables
...
class Stack(object):
    ...
    Attributes:
        definition (:class:`r4y.cfngin.config.Stack`): The stack definition
            from the config.
    ...
    def __init__(self, definition, context, variables=None, mappings=None,
        ...
        Args:
            definition (:class:`r4y.cfngin.config.Stack`): A stack
                definition.
            context (:class:`r4y.cfngin.context.Context`): Current context
    ...
    def parameter_values(self):
        ...
        with a :class:`r4y.cfngin.blueprints.variables.types.CFNType`
        ``type``.
    ...
    def resolve(self, context, provider):
        ...
        Args:
            context (:class:`r4y.cfngin.context.Context`): CFNgin context.
            provider (:class:`r4y.cfngin.providers.base.BaseProvider`):
