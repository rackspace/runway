...
def should_update(stack):
    ...
    Args:
        stack (:class:`r4y.cfngin.stack.Stack`): The stack object to check.
...
def _resolve_parameters(parameters, blueprint):
    ...
    Args:
        parameters (dict): A dictionary of parameters provided by the
            stack definition
        blueprint (:class:`r4y.cfngin.blueprint.base.Blueprint`):
...
def handle_hooks(stage, hooks, provider, context, dump, outline):
    ...
    Args:
        ...
        provider (:class:`r4y.cfngin.providers.base.BaseProvider`): The provider
            the current stack is using.
        context (:class:`r4y.cfngin.context.Context`): The current CFNgin
            context.
...
class Action(BaseAction):
    ...
    def build_parameters(stack, provider_stack=None):
        ...
        Args:
            stack (:class:`r4y.cfngin.stack.Stack`): A CFNgin stack.
    ...
    def _destroy_stack(self, stack, **kwargs):  # pylint: disable=too-many-return-statements
        ...
        Args:
            stack (:class:`r4y.cfngin.stack.Stack`): Stack to be deleted.
    ...
    def _launch_stack(self, stack, **kwargs):  # pylint: disable=R
        ...
        Args:
            stack (:class:`r4y.cfngin.stack.Stack`): Stack to be launched.
        ...
        if provider_stack and old_status == SUBMITTED:
            ...
            if provider.is_stack_rolling_back(provider_stack):  # pylint: disable=no-else-return
