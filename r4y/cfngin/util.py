...
def get_soa_record(client, zone_id, zone_name):
    ...
    Returns:
        :class:`r4y.cfngin.util.SOARecord`: An object representing the
...
class SourceProcessor(object):
    ...
    def __init__(self, sources, cfngin_cache_dir=None):
        ...
        if not cfngin_cache_dir:
            cfngin_cache_dir = os.path.expanduser("~/.r4y_cache")
    ...
    def determine_git_ls_remote_ref(config):
        ...
        Args:
            config (:class:`r4y.cfngin.config.GitPackageSource`): Git
