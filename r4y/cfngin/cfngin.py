...
from r4y.util import AWS_ENV_VARS, MutableMap, cached_property
...
LOGGER = logging.getLogger('r4y.cfngin')
...
class CFNgin(object):
    ...
    def __init__(self, ctx, parameters=None, sys_path=None):
        ...
        Args:
            ctx (r4y.context.Context): Runway context object.
    ...
    def load(self, config_path):
        ...
        Returns:
            :class:`r4y.cfngin.context.Context`
    ...
    def _get_config(self, file_path, validate=True):
        ...
        Returns:
            :class:`r4y.cfngin.config.Config`
    ...
    def _get_context(self, config, config_path):
        ...
        Args:
            config (:class:`r4y.cfngin.config.Config): CFNgin config object.
