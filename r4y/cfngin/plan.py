...
class Step(object):
    ...
    Attributes:
        ...
        stack (:class:`r4y.cfngin.stack.Stack`): the stack associated with
            this step
        status (:class:`r4y.cfngin.status.Status`): The status of step.
    ...
    def __init__(self, stack, fn=None, watch_func=None):
        ...
        Args:
            stack (:class:`r4y.cfngin.stack.Stack`): The stack associated
                with this step
            fn (Optional[Callable]): Function to run to execute the step.
    ...
    def set_status(self, status):
        ...
        Args:
            status (:class:`r4y.cfngin.status.Status`): The status to set the
                step to.
    ...
    def from_stack_name(cls, stack_name, context, requires=None, fn=None,
        ...
        Args:
            ...
            context (:class:`r4y.cfngin.context.Context`): Context object.
                Required to initialize a "fake" :class:`r4y.cfngin.stack.Stack`.
        ...
        """
        from r4y.cfngin.config import Stack as StackConfig
...
class Graph(object):
    ...
    action for a set of :class:`r4y.cfngin.stack.Stack` objects. When
    initialized with a set of steps, it will first build a Directed Acyclic
    Graph from the steps and their dependencies.

    Attributes:
        dag (:class:`r4y.cfngin.dag.DAG`): an optional
            :class:`r4y.cfngin.dag.DAG` object. If one is not provided, a
    ...
    def __init__(self, steps=None, dag=None):
        ...
        Args:
            steps (Optional[Dict[str, :class:`Step`]]): Dict with key of step
                ...
                :class:`r4y.cfngin.dag.DAG` that already includes these
                steps should also be provided..
            dag (Optional[:class:`r4y.cfngin.dag.DAG`]): An optional
                :class:`r4y.cfngin.dag.DAG` object. If one is not provided,
    ...
    def walk(self, walker, walk_func):
        ...
        Args:
            walker (Callable[[:class:`r4y.cfngin.dag.DAG`], Any]): Function
    ...
    def from_dict(cls, graph_dict, context):
        ...
        Args:
            graph_dict (Dict[str, List[str]]): The dictionary used to
                create the graph.
            context (:class:`r4y.cfngin.context.Context`): Required to init
                stacks.
...
class Plan(object):
    ...
    def dump(self, directory, context, provider=None):
        ...
        Args:
            ...
            context (:class:`r4y.cfngin.context.Contest`): Current CFNgin
                context.
            provider (:class:`r4y.cfngin.providers.aws.default.Provider`):
    ...
    def walk(self, walker):
        ...
        Args:
            walker (func): a walker function to be passed to
                :class:`r4y.cfngin.dag.DAG` to walk the graph.
