...
# using absolute for r4y imports so stacker shim doesn't break when used from CFNgin
...
if TYPE_CHECKING:
    from r4y.context import Context as RunwayContext  # noqa: F401 pylint: disable=W
    from r4y.cfngin.context import Context as CFNginContext  # noqa: F401 pylint: disable=W
