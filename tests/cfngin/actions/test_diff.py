...
def generate_get_template(file_name='cfn_template.json',
    ...
    with open(os.path.join(fixture_dir, file_name), 'r') as template_file:
        return {
...
class TestMethods(unittest.TestCase):
    """Tests for runway.cfngin.actions.diff methods."""
...
class TestProviderDefaultMode(unittest.TestCase):
    """Tests for runway.cfngin.actions.diff provider default mode."""
...
class TestProviderInteractiveMode(unittest.TestCase):
    """Tests for runway.cfngin.actions.diff provider interactice mode."""
