...
def test_tfenv_uninstall_all_takes_precedence(caplog: LogCaptureFixture, cd_tmp_path: Path) -> None:
...
def test_tfenv_uninstall_all_none_installed(caplog: LogCaptureFixture, cd_tmp_path: Path) -> None:
...
def test_tfenv_uninstall_no_version(caplog: LogCaptureFixture, cd_tmp_path: Path) -> None:
