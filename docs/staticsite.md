...
The static website module plugin (see general overview in [README](https://github.com/onicagroup/runway/blob/master/README.md)) has a number of available options:
