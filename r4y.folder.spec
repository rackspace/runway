"""pyinstaller spec file to build a single-binary distribution of r4y.
...
data_files = [
    (os.path.join(CLI_PATH, 'templates'), './r4y/templates/'),
    (os.path.join(CLI_PATH, 'blueprints'), './r4y/blueprints/'),
    (os.path.join(CLI_PATH, 'hooks'), './r4y/hooks/')
]
...
hiddenimports.extend(get_submodules(r4y))
