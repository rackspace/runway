...
def document_model_driven_method(section, method_name, operation_model, event_emitter, method_description=..., example_prefix=..., include_input=..., include_output=..., exclude_input=..., exclude_output=..., document_output=..., include_signature=...):
