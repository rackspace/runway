...
class Session(object):
    ...
    def create_client(self, service_name, region_name=..., api_version=..., use_ssl=..., verify=..., endpoint_url=..., aws_access_key_id=..., aws_secret_access_key=..., aws_session_token=..., config=...):
...
class SubsetChainConfigFactory(object):
    ...
    def create_config_chain(self, instance_name=..., env_var_names=..., config_property_name=..., default=..., conversion_func=...):
