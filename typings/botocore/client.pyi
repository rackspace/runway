...
class ClientCreator(object):
    ...
    def __init__(self, loader, endpoint_resolver, user_agent, event_emitter, retry_handler_factory, retry_config_translator, response_parser_factory=..., exceptions_factory=..., config_store=...) -> None:
        ...

    def create_client(self, service_name, region_name, is_secure=..., endpoint_url=..., verify=..., credentials=..., scoped_config=..., api_version=..., client_config=...):
        ...
...
class ClientEndpointBridge(object):
    ...
    def __init__(self, endpoint_resolver, scoped_config=..., client_config=..., default_endpoint=..., service_signing_name=...) -> None:
        ...
...
class BaseClient(object):
    _PY_TO_OP_NAME = ...
    def __init__(self, serializer, endpoint, response_parser, event_emitter, request_signer, service_model, loader, client_config, partition, exceptions_factory) -> None:
        ...
