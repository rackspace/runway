...
BOTOCORE_DEFAUT_SESSION_VARIABLES = { 'profile': (None, ['AWS_DEFAULT_PROFILE', 'AWS_PROFILE'], None, None),'region': ('region', 'AWS_DEFAULT_REGION', None, None),'data_path': ('data_path', 'AWS_DATA_PATH', None, None),'config_file': (None, 'AWS_CONFIG_FILE', '~/.aws/config', None),'ca_bundle': ('ca_bundle', 'AWS_CA_BUNDLE', None, None),'api_versions': ('api_versions', None, {  }, None),'credentials_file': (None, 'AWS_SHARED_CREDENTIALS_FILE', '~/.aws/credentials', None),'metadata_service_timeout': ('metadata_service_timeout', 'AWS_METADATA_SERVICE_TIMEOUT', 1, int),'metadata_service_num_attempts': ('metadata_service_num_attempts', 'AWS_METADATA_SERVICE_NUM_ATTEMPTS', 1, int),'ec2_metadata_service_endpoint': ('ec2_metadata_service_endpoint', 'AWS_EC2_METADATA_SERVICE_ENDPOINT', None, None),'imds_use_ipv6': ('imds_use_ipv6', 'AWS_IMDS_USE_IPV6', False, None),'parameter_validation': ('parameter_validation', None, True, None),'csm_enabled': ('csm_enabled', 'AWS_CSM_ENABLED', False, utils.ensure_boolean),'csm_host': ('csm_host', 'AWS_CSM_HOST', '127.0.0.1', None),'csm_port': ('csm_port', 'AWS_CSM_PORT', 31000, int),'csm_client_id': ('csm_client_id', 'AWS_CSM_CLIENT_ID', '', None),'endpoint_discovery_enabled': ('endpoint_discovery_enabled', 'AWS_ENDPOINT_DISCOVERY_ENABLED', 'auto', None),'sts_regional_endpoints': ('sts_regional_endpoints', 'AWS_STS_REGIONAL_ENDPOINTS', 'legacy', None),'retry_mode': ('retry_mode', 'AWS_RETRY_MODE', 'legacy', None),'max_attempts': ('max_attempts', 'AWS_MAX_ATTEMPTS', None, int) }
DEFAULT_S3_CONFIG_VARS = { 'addressing_style': (('s3', 'addressing_style'), None, None, None),'use_accelerate_endpoint': (('s3', 'use_accelerate_endpoint'), None, None, utils.ensure_boolean),'use_dualstack_endpoint': (('s3', 'use_dualstack_endpoint'), None, None, utils.ensure_boolean),'payload_signing_enabled': (('s3', 'payload_signing_enabled'), None, None, utils.ensure_boolean),'use_arn_region': (['s3_use_arn_region', ('s3', 'use_arn_region')], 'AWS_S3_USE_ARN_REGION', None, utils.ensure_boolean),'us_east_1_regional_endpoint': (['s3_us_east_1_regional_endpoint', ('s3', 'us_east_1_regional_endpoint')], 'AWS_S3_US_EAST_1_REGIONAL_ENDPOINT', None, None) }
DEFAULT_PROXIES_CONFIG_VARS = { 'proxy_ca_bundle': ('proxy_ca_bundle', None, None, None),'proxy_client_cert': ('proxy_client_cert', None, None, None),'proxy_use_forwarding_for_https': ('proxy_use_forwarding_for_https', None, None, utils.normalize_boolean) }
...
class ConfigChainFactory(object):
    ...
    def create_config_chain(self, instance_name=..., env_var_names=..., config_property_names=..., default=..., conversion_func=...):
