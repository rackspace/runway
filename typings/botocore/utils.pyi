...
import re
import logging
from botocore.exceptions import ConnectTimeoutError, ConnectionClosedError, EndpointConnectionError, ReadTimeoutError
...
class S3EndpointSetter(object):
    _DEFAULT_PARTITION = ...
    _DEFAULT_DNS_SUFFIX = ...
    def __init__(self, endpoint_resolver, region=..., s3_config=..., endpoint_url=..., partition=...) -> None:
        ...
