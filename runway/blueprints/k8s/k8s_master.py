...
# Autogenerated condition classes trip up pylint
...
from runway.cfngin.blueprints.variables.types import (
    CFNString, EC2SubnetIdList, EC2VPCId
)
...
class Cluster(Blueprint):
    ...
    VARIABLES = {
        'EksClusterName': {'type': CFNString,
                           ...
                           'min_length': 2,
                           'max_length': 40},
        'EksSubnets': {'type': EC2SubnetIdList,
                       'description': 'Subnets where the Kubernetes cluster '
                                      'will live'},
        'EksVersion': {'type': CFNString,
